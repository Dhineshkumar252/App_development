...
public class AuthenticationService {
    ...
    public ApplicationUser registerUser(String username,String email,int contactNumber, String password,String confirmpassword){
        ...
        return userRepository.save(new ApplicationUser(0, username, email,contactNumber,encodedPassword, encodedPassword,authorities));
    }
